...
var mailer = {
	mailTargetAudience:function(reqBody){
		return new Promise(function(resolve, reject){
			...
			var mailOptions = {
			  from: 'hexatestmailer@gmail.com,harikrishnanv@hexaware.com',
			  to: 'haritechno92@gmail.com',
			  //to:'wilfredf@hexaware.com,saisub@hexaware.com,omprakashr@hexaware.com,arjunb@hexaware.com,ravindra.gharpure@gmail.com',
...
mailPackageDetails:function(){
	return new Promise(function(resolve, reject){
		...
		readModuleFile('./mail.html').then((words)=> {
			...
			to: 'haritechno92@gmail.com,harikrishnanv@hexaware.com',
